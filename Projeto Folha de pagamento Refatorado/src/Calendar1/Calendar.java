...
public class Calendar {
    ...
    public boolean changePaymentSchedule (ArrayList <Person> employees, int id) {
        ...
        for (Person e: employees) {
            ...
            if (e.getId() == id) {
                ...
                e.setPaySchedule(getPaySche().get(op2));
    ...
    public static void generatePayment (Person e, double salary, double serviceCharges, double syndicalRates, double totalRates) {

        System.out.println("############### Contra-cheque ###############");
        System.out.println();
        System.out.println("ID: " + e.getId());
        System.out.println("Nome: " + e.getName());
        System.out.println("Forma de pagamento: " + e.getPayMethod());

        if (e.getPaySchedule().equals("Mensal")) {
    ...
    /*Calculo das taxas*/
    public static void charges (Person e) {
        ...
        if (e.getPaySchedule().equals("Bi-semanal")) {
    ...
    /*Folha de pagamento*/
    public void payRoll (ArrayList <Person> employees) {

        if (this.currentDay == this.daysMonth[this.currentMonth]) {

            for (Person e: employees) {

                if (e.getPaySchedule().equals("Mensal") && e.getPayDay() > this.currentDay) {
        ...
        for (Person e : employees) {
            ...
            if (e.getPaySchedule().equals("Semanal") && e.getPayWeek().equals(this.weeksName[(this.currentDayAux-1)%7])) {

                charges(e);
                reset(e);
            }

            if (e.getPaySchedule().equals("Bi-semanal") && e.getPayWeek().equals(this.weeksName[(this.currentDayAux-1)%7])) {
