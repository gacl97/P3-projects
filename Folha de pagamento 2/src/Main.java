...
public class Main {
           ...
           if (employees[i][0] != null && employees[i][0].equals(id)) {
               ...
               while (true) {
                   ...
                   if (option2 == 1) {
                       ...
                       System.out.println("Novo método de pagamento: [Cheque por correios, Cheque em mãos, Déposito em conta bancaria]");
       ...
       boolean flag = false;
        ...
        for (int i = 0; i < employees.length; i++) {
            ...
            if (employees[i][0] != null) {
                ...
                System.out.println("Adress: " + employees[i][2]);
                System.out.println("Type: " + employees[i][3]);
                System.out.println("Payment day: " + employees[i][12]);
                System.out.println("payment week day: " + employees[i][14]);
                System.out.println("Payment method: " + employees[i][6]);
                System.out.println("Payment: " + employees[i][13]);

                if (employees[i][3].equals("Hourly")) {
                    System.out.println("Hours salary: " + employees[i][7]);
                } else {
                    System.out.println("Salary: " + employees[i][4]);
                    System.out.println("Commissioned: " + employees[i][11]);
                    if (employees[i][11].equals("true")) {
                        System.out.println("Commission fee: " + employees[i][9]);
                    }
                }
                System.out.println("Belongs to a union: " + employees[i][17]);
                if (employees[i][17].equals("true")) {
                    System.out.println("Sindical Id: " + employees[i][15]);
                    System.out.println("Sindical fee: " + employees[i][16]);
                }
                System.out.println("---------------------------------");
            }
        }
    ...
    public static void hitPoint (String [][]employees) {
        ...
        System.out.println("Hour salary: " + hourSalary);
        System.out.println("Extra hour: " + extraHour);
    ...
    public static void addEmployee (String [][]employees, String id) {
        ...
        System.out.println("Informe o método de pagamento do empregado: [Cheque por correios, Cheque em mãos, Déposito em conta bancaria] ");
        employees[i][6] = input.nextLine();
